...
function PageGraphMock() {
  ...
  const nodeColor = (degree: number) => {
    if (degree >= 5) return HUB_COLOR;
    if (degree >= 3) return CONNECTED_COLOR;
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-[13.5px] leading-[1.6] text-dim">
              ...
              Blue nodes are the hubs your agents keep citing.
            </p>
          </div>
        </div>
      </div>
