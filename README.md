...
<p align="center">
  Stash is a CLI to search over your team's coding agent sessions. <br> It captures every coding-agent run across your team and turns it into a shared, evolving asset every agent can build on.
</p>
