...
import type { PublicSkillItem } from "../../../../lib/api";

// Inline body renderers used on the /skills/[slug] detail page when the
// skill contains a single page or single session — we render the content
...
export function PageBody({ item }: { item: PublicSkillItem }) {
...
export function FolderBody({ item }: { item: PublicSkillItem }) {
...
export function SessionBody({ item }: { item: PublicSkillItem }) {
