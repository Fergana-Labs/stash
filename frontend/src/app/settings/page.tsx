...
// Trained models live on their own page; this is the way there for someone
// who has not installed a skill that brings them.
function ModelsSection() {
  const router = useRouter();
  return (
    <section className="rounded-2xl border border-border bg-surface p-6 space-y-2">
      <h2 className="text-base font-semibold text-foreground">Models</h2>
      <p className="text-sm text-muted-foreground">
        Train a model on your own writing so your agent can draft in your voice. One-time fee per
        training run, unlimited use after.
      </p>
      <button
        type="button"
