...
skills, the anonymized cross-user skill, isolation) is Stash's job.
"""
...
class Stash:
    ...
    def read(self, user: str, script: str) -> str:
        ...
        shared Skill at /skills/shared, their own Skill at /skills/personal and uploads under /files, and
