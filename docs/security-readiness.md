...
- Workspace-readable, public, or discoverable session folders must require workspace owner membership; private session-folder management must require current workspace write access.
