...
async def _get_user_from_api_key(token: str, *, managed_auth_enabled: bool) -> dict:
    ...
    row = await pool.fetchrow(
        ...
        "       u.plan, u.plan_intent, u.developer_platform_only, u.personal_integrations_enabled, "
...
async def _get_user_from_jwt(token: str) -> dict:
    ...
    row = await pool.fetchrow(
        ...
        "       role, referral_source, use_case, plan, plan_intent, developer_platform_only, personal_integrations_enabled "
